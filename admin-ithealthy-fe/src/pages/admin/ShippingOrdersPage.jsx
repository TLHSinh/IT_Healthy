...
import { Truck, RefreshCcw, List, Grid, Search } from "lucide-react";
...
const ShippingOrdersPage = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      toast.error("Lấy dữ liệu đơn hàng shipping thất bại");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-wrap items-center justify-between mb-4 gap-3">
        <h2 className="flex items-center gap-3 text-3xl font-extrabold text-green-600">
          <Truck className="w-8 h-8 text-green-600" strokeWidth={2.5} />
          Đơn hàng Giao - Nhận (COD)
        </h2>
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          <div className="flex items-center w-full sm:w-64 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden focus-within:ring-2 focus-within:ring-green-300 transition">
            <input
              type="text"
        ...
        {viewMode === "table" ? (
          ...
          >
            <table className="min-w-full bg-white rounded-lg overflow-hidden">
              <thead className="bg-green-200 text-gray-700 uppercase text-sm sticky top-0">
                <tr>
      ...
      {/* 🔹 Pagination nằm ngoài table/card */}
